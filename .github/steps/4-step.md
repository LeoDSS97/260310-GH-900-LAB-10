...
1. Click the **Add a suggestion** button to insert a modifiable copy of the line.
   ...
   <img width="300" alt="add-a-suggestion-button" src="https://github.com/LeoDSS97/260310-GH-900-LAB-10/blob/main/.github/images/add-a-suggestion-button.png?raw=true" />
